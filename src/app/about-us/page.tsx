    ...
    <Section>
      ...
      <ul className="text-white">
        ...
        <li>
          ...
          both exciting and frustrating. As veterans in the field, we understand
          the challenges and the unique culture that surrounds botting. Over the
          years, we have witnessed numerous changes in the botting landscape,
          and we have seen the community evolve.
        </li>
        <li>
        ...
        <li>
          Driven by our passion for both the game and the botting community, we
          have taken it upon ourselves to bridge this gap. Our aim is to
          ...
          tirelessly to create a bot that encompasses every feature imaginable.
        </li>
        <li>
          Unlike other products on the market, we believe that price should not
          hinder anyone's ability to enjoy the benefits of botting. We have
          adopted an affordable and transparent pricing structure, ensuring that
          our product remains accessible to all operators who wish to enhance
          their World of Warcraft experience.
        </li>
        <li>
          ...
          listen carefully to our operators feedback. We value the trust placed
          in us and strive to maintain an open and honest relationship with our
          community.
        </li>
        <li>
          ...
          and the affordability that you deserve, we invite you to embark on our
          journey.
        </li>
        <li>
          Join us and witness the next level of botting innovation in World of
          Warcraft. Together, let's redefine what it means to have the complete
          botting experience.
        </li>
      </ul>
    </Section>
