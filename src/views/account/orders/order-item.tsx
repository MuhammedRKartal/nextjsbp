...
export const OrderItem = (props: OrderProps) => {
  ...
  return (
    <div
      className={twMerge(
        "relative flex flex-col border w-full py-5 px-5  border-outline lg:px-10 lg:py-8",
        className
      )}
    >
      <div className="flex flex-col gap-6 border-b border-outline pb-4 mb-12 lg:pb-2 lg:mb-8 lg:gap-4">
