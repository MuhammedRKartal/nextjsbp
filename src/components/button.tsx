  ...
  return twMerge(
    clsx(
      ...
      (props.appearance === "filled" || !props.appearance) &&
        "text-white bg-primary border-secondaryoutline hover:bg-primary-600 hover:border-outline",
      props.appearance === "outlined" &&
        "bg-black border-secondaryoutline hover:border-outline hover:bg-primary-600",
      props.appearance === "ghost" && "bg-transparent border-transparent hover:bg-primary-600",
