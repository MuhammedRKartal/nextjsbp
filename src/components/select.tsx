  ...
  return (
    ...
    >
      ...
      {loading === true ? (
        ...
        <div
          className={twMerge(
            'relative border border-outline dark:border-secondaryoutline dark:border-secondaryoutline-100 text-xs py-2 px-3 cursor-pointer',
            labelClassName
          )}
          ...
          return (
            <li
              className={twMerge(
                ...
                'hover:bg-primary-100 dark:bg-secondary-900',
                itemClassName
              )}
