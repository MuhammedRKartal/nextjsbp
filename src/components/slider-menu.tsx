    ...
    <div
      ...
      className={twMerge(
        clsx(
          ...
          'fixed bottom-0 right-0 h-screen bg-secondary-black text-white z-50 transition-all duration-300 p-5 w-full',
          enableDesktop &&
            clsx(
              open
                ? 'lg:scroll-visible lg:translate-y-[calc(100%)]'
                : 'lg:translate-x-0 lg:translate-y-[calc(100%+16px)]',
              'lg:h-auto lg:absolute lg:right-8 lg:-bottom-1 lg:border lg:border-secondary-darkest lg:rounded',
              `${desktopWidth}`
            )
        ),
        className
